-- Initial API schema. Every statement is safe against databases created by the
-- original schema.sql so existing installations can enter migration history by
-- actually executing the migration rather than being falsely baselined.
